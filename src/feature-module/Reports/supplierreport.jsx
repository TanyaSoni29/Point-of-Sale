...
import {
	...
	returnsupplierdata,
	supplierreportdata,
} from '../../core/json/supplierreportdata';
import Table from '../../core/pagination/datatable';
import CloseImg from '../../assets/img/icons/closes.svg';
import PaymentStatusImg from '../../assets/img/icons/payment-status.svg';
...
const SupplierReport = () => {
	...
	const columns = [
		...
		},
		{
			title: 'Status',
			dataIndex: 'status',
			render: (text) => <span className='badges status-badge'>{text}</span>,
	...
	const columnsreturnsupplier = [
		...
		},
		{
			...
			render: (text) => (
				<div>
					{text === 'Paid' && <span className='badge-linesuccess'>{text}</span>}
					{text === 'Unpaid' && (
						<span className='badge badge-linedanger'>{text}</span>
					)}
					{text === 'Overdue' && <span className='badges-warning'>{text}</span>}
				</div>
			),
						...
						>
							...
							<div className='card table-list-card'>
								<div className='card-body'>
									...
									<div className='table-responsive'>
										<Table
											columns={columnsreturnsupplier}
											dataSource={returnsupplierdatasource}
										/>
									</div>
								</div>
							</div>
