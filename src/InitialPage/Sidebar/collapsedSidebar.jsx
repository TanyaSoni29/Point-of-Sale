...
const CollapsedSidebar = () => {
	...
	return (
		<div
			className='sidebar collapsed-sidebar'
			id='collapsed-sidebar'
		>
			<div className='sidebar-inner slimscroll'>
				<div
					id='sidebar-menu-2'
					className='sidebar-menu sidebar-menu-three'
				>
					<aside
						id='aside'
						className='ui-aside'
