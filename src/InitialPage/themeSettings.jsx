...
import { setLayoutStyleData } from '../slices/productListSlice';
import themeImg01 from '../assets/img/theme/theme-img-01.jpg';
import themeImg02 from '../assets/img/theme/theme-img-02.jpg';
import themeImg03 from '../assets/img/theme/theme-img-03.jpg';
import themeImg04 from '../assets/img/theme/theme-img-04.jpg';
import themeImg05 from '../assets/img/theme/theme-img-05.jpg';
import themeImg06 from '../assets/img/theme/theme-img-06.jpg';
import themeImg07 from '../assets/img/theme/theme-img-07.jpg';
...
const ThemeSettings = () => {
	...
	const DefaultStyle = () => {
		...
		dispatch(setLayoutStyleData('default'));
	...
	const LayoutBox = () => {
		...
		setLayoutView('box');
		dispatch(setLayoutStyleData('box'));
	...
	const collapsedLayout = () => {
		...
		dispatch(setLayoutStyleData('collapsed'));
	...
	const HorizontalLayout = () => {
		...
		dispatch(setLayoutStyleData('horizontal'));
	...
	const modernLayout = () => {
		...
		dispatch(setLayoutStyleData('modern'));
